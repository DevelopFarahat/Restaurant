...
@Component({
  selector: 'app-pasta-category',
  templateUrl: './pasta-category.component.html',
  styleUrls: ['./pasta-category.component.css']
})
export class PastaCategoryComponent implements OnInit {
  listOfPasta:Icategory;
  pastaCategory_url:string = "/assets/json/pasta.json";
  ...
  ngOnInit(): void {
    ...
    this.categoryS.getAllCategoryDetails(this.pastaCategory_url).subscribe((data) => this.listOfPasta = data);

    this.categoryS.getAllCategoryDetails(this.pastaCategory_url).subscribe((data) => {
